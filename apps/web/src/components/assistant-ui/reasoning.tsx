...
const ReasoningText = ({ className, children, ...props }: React.ComponentProps<"div">) => {
  const isPreview = useContext(ReasoningPreviewContext);
  ...
  return (
    <div
      ...
      className={cn(
        "aui-reasoning-text relative z-0 max-h-64 overflow-y-auto ps-6 py-2 leading-relaxed text-pretty",
...
export {
  ...
  ReasoningText,
  ReasoningFade,
  // eslint-disable-next-line react-refresh/only-export-components -- source-owned variant API
  reasoningVariants,
};
